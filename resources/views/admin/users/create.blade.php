        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                    Fill in the details below to register a new account in the system.
                </p>
            </div>
                        ...
                        <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="relative mt-1">
                                    ...
                                    <x-text-input id="name" name="name" type="text" class="pl-10 block w-full"
                                        :value="old('name')" required autofocus autocomplete="name" placeholder="e.g. John Doe" />
                                </div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="relative mt-1">
                                    ...
                                    <x-text-input id="email" name="email" type="email" class="pl-10 block w-full"
                                        :value="old('email')" required autocomplete="username" placeholder="name@institution.edu" />
                                </div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="relative mt-1">
                                    ...
                                    <select id="role" name="role"
                                        ...
                                        <option value="user" {{ old('role') === 'user' ? 'selected' : '' }}>User (Student/Staff)</option>
                                        <option value="admin" {{ old('role') === 'admin' ? 'selected' : '' }}>Administrator</option>
                                    </select>
                                </div>
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Determines the permission level within the system.</p>
                            ...
                            <div class="sm:col-span-1">
                                ...
                                <div class="relative mt-1">
                                    ...
                                    <x-text-input id="password" name="password" type="password" class="pl-10 block w-full"
                            ...
                            <div class="sm:col-span-1">
                                ...
                                <div class="relative mt-1">
                                    ...
                                    <x-text-input id="password_confirmation" name="password_confirmation" type="password"
                                        class="pl-10 block w-full" required autocomplete="new-password" placeholder="••••••••" />
                                </div>
                                <x-input-error class="mt-2" :messages="$errors->get('password_confirmation')" />
                            </div>
                        </div>

                        <div class="flex items-center justify-end gap-4 pt-4 border-t border-gray-100 dark:border-gray-700 mt-6">
                            <a href="{{ route('admin.users.index') }}"
